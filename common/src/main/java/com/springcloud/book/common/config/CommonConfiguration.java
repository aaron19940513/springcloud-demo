package com.springcloud.book.common.config;


import com.springcloud.book.common.context.SpringCloudHystrixConcurrencyStrategy;
import com.springcloud.book.common.intercepter.FeignUserContextInterceptor;
import com.springcloud.book.common.intercepter.RestTemplateUserContextInterceptor;
import com.springcloud.book.common.intercepter.UserContextInterceptor;
import feign.Feign;
